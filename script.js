// ==============================================
// REAL-TIME SYNC SYSTEM - نظام المزامنة
// ==============================================
...
// ==============================================
// GLOBAL NOTIFICATION SYSTEM - نظام الإشعارات
// ==============================================
...
// ==============================================
// PRODUCTS DATABASE WITH ADMIN SYNC - قاعدة المنتجات
// ==============================================
...
// ==============================================
// SHOPPING CART SYSTEM - نظام السلة
// ==============================================
...
// ==============================================
// CHECKOUT SYSTEM WITH EMAILJS - نظام الدفع
// ==============================================
...
// ==============================================
// MAIN APPLICATION WITH LOAD MORE - التطبيق الرئيسي
// ==============================================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // إصلاح Checkout Button على الموبايل
    if (window.innerWidth <= 768) {
        const checkoutBtn = document.getElementById('checkoutBtn');
        if (checkoutBtn) {
...
// ==============================================
// CUSTOM CONFIRM DIALOG - نافذة التأكيد
// ==============================================
